...
<?php
						if(preg_match('/(\(1 ja, 0 nein\))|(\(0 nein, 1 ja\))/', $description)) {
?>
							<td>
								<select name="value">
...
?>
							<td><input style="width: 400px;" type="text" name="value" value="<?php print $setting; ?>" /></td>
<?php
						}
?>
						<td><input style="width: 600px;" type="text" name="description" value="<?php print htmlentities($description); ?>" readonly /></td>
...
?>
								<input type="submit" style="font-size: 10px;" name="reset_setting" value="Reset nach <?php print htmlentities($default_setting); ?>" />
<?php
							}
?>
						</td>
