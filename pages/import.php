...
?>
			<form method="post" enctype="multipart/form-data" action="admin.php?page=<?php print $GLOBALS['this_page_number']; ?>">
				...
				<input noautosubmit="1" type="submit" value="Upload!" />
			</form>
<?php
			if($GLOBALS['import_table']) {
				echo $GLOBALS['import_table'];

				echo "<iframe style='display: none;' width='0' height='0' src='admin.php?page=".get_page_id_by_filename('wartungstermine2.php')."&jahreplus=5'></iframe>";
			}
		} else {
?>
